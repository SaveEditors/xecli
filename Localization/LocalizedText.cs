...
internal static partial class LocalizedText
{
    ...
    private static readonly Dictionary<string, string> ManualOverrides = new(StringComparer.Ordinal)
    {
        ...
        ["Ayudantes de falsificación privados que reconocen títulos. BO2 admite GT local, XUID local y suplantación de identidad remota"] = "Herramientas privadas de spoofing según el título. BO2 admite GT local, XUID local y spoofing remoto",
        ["Private title-aware spoof helpers. BO2 supports local GT, local XUID, and remote spoofing."] = "Herramientas privadas de spoofing según el título. BO2 admite GT local, XUID local y spoofing remoto.",
        ...
        ["IDA Pro headless helpers (IDA Pro 9.1.250226 required, external install required)"] = "Herramientas sin interfaz de IDA Pro (requiere IDA Pro 9.1.250226 e instalación externa)",
        ["IDA Pro headless helpers (IDA Pro 9.1.250226 required, external install required)."] = "Herramientas sin interfaz de IDA Pro (requiere IDA Pro 9.1.250226 e instalación externa).",
        ["Configure IDA install, python, and backend paths."] = "Configura las rutas de instalación de IDA, Python y el backend.",
        ["Verify the configured IDA 9.1 + SaveEditors idaxex 0.42b-compat environment."] = "Verifica el entorno configurado de IDA 9.1 + SaveEditors idaxex 0.42b-compat.",
        ["Download or install the supported SaveEditors idaxex 0.42b-compat loader set into IDA."] = "Descarga o instala en IDA el conjunto de cargadores compatible de SaveEditors idaxex 0.42b-compat.",
