...
internal static partial class LocalizedText
{
    ...
    private static readonly Dictionary<string, string> ManualOverrides = new(StringComparer.Ordinal)
    {
        ...
        ["Verify the configured IDA 9.1 + idaxex 0.42b environment."] = "Verifica el entorno configurado de IDA 9.1 + idaxex 0.42b.",
        ["Download or install the supported idaxex 0.42b loader set into IDA."] = "Descarga o instala en IDA el conjunto de cargadores compatible de idaxex 0.42b.",
