# XeCLI modification, 2026-07-19: remap build-machine source paths in output.
#---------------------------------------------------------------------------------
...
CFLAGS	= -ffunction-sections -fdata-sections -g -Os -Wall -ffile-prefix-map=$(abspath ..)=. $(MACHDEP) $(INCLUDE)
CXXFLAGS	=	$(CFLAGS)
ASFLAGS		=	-m32
