...
internal static class XellAssetHelpers
{
	...
	private static readonly IReadOnlyDictionary<string, (string SourceDescription, string BehaviorSummary)> KnownXellPayloads = new Dictionary<string, (string SourceDescription, string BehaviorSummary)>(StringComparer.OrdinalIgnoreCase)
	{
		...
		{
			"E364FAD816CD651B1F27C1A7DCD5AE8A0C3A3C70BF11D04B6A66123A38AF2C9C",
			("XeCLI-XellFetch v2.0 payload build (alex-free/xell-reloaded v0.993-d4f08b4, xell-2f)", "Shows the XeCLI waiting screen, job-aware progress states, verified keyvault export support, and token-gated verified reboot flow used by XeCLI.")
		},
		{
