...
namespace NoDev.XContent
{
    public class XContentMetadata
    {
        ...
        public dynamic Descriptor = null!;
        ...
        public string Publisher = string.Empty; // 128
        public string TitleName = string.Empty; // 128
        ...
        private byte[] _unknownInstallerData = Array.Empty<byte>();
        ...
        private byte[] _deviceId = Array.Empty<byte>(); // 20
        ...
        private byte[] _titleThumbnail = Array.Empty<byte>();
        ...
        private byte[] _descriptorData = Array.Empty<byte>();
