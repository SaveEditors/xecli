...
namespace NoDev.Xbox360
{
    ...
    public class MediaIndex
    {
        ...
        public XMIENTRY_MASTERLIST[] MasterList = Array.Empty<XMIENTRY_MASTERLIST>();

        public List<XMIENTRY_MUSIC_ALBUM> Albums = new List<XMIENTRY_MUSIC_ALBUM>();
        public List<XMIENTRY_MUSIC_TRACK> Tracks = new List<XMIENTRY_MUSIC_TRACK>();
        public List<XMIENTRY_MUSIC_ARTIST> Artists = new List<XMIENTRY_MUSIC_ARTIST>();
        public List<XMIENTRY_MUSIC_GENRE> Genres = new List<XMIENTRY_MUSIC_GENRE>();
        public List<XMIENTRY_MUSIC_PLAYLIST> Playlists = new List<XMIENTRY_MUSIC_PLAYLIST>();
