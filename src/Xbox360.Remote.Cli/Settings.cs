...
public class ConnectionSettings : CommandSettings {
    ...
    [CommandOption("--target-profile <NAME>")]
    [LocalizedDescription("Use a saved target profile by name.")]
    ...
    [LocalizedDescription("XBDM connection/read stall timeout in milliseconds (default: 5000).")]
    ...
    [CommandOption("--no-reconnect")]
    [LocalizedDescription("Disable automatic XBDM reconnect attempts.")]
