    ...
    public class STFSPackage
    {
        ...
        public STFSPackage(CreateSTFS xSession, RSAParams xSigning, string xOutPath, LogRecord LogIn)
        {
            ...
            try
            {
                ...
                // XeCLI's legacy QuickBoot shortcut is a normal STFS container
                // tagged as GamesOnDemand. Permit that lightweight container;
                // true installed-game layouts remain rejected below.
                else if (xSession.HeaderData.ThisType == PackageType.HDDInstalledGame ||
